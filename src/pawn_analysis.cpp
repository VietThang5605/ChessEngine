...
namespace {
    ...
    constexpr eval_help::Score PassedRank[RANK_NB] = {
        S(0 * 100.0 / 128.0, 0), S(10 * 100.0 / 128.0, 28 *100.0 / 213.0), S(17 * 100.0 / 128.0, 33 *100.0 / 213.0), S(15 * 100.0 / 128.0, 41 *100.0 / 213.0), S(62 * 100.0 / 128.0, 72 *100.0 / 213.0), S(168 * 100.0 / 128.0, 177 *100.0 / 213.0), S(276 * 100.0 / 128.0, 260 *100.0 / 213.0)
        };
